  ...
  try {
    ...
    for (const solicitud of solicitudes) {
      const solicitudData = {
        ...
        mensajeCapacitacion: solicitud.mensajeCapacitacion,
      ...
      if (solicitud.colaboradores && solicitud.colaboradores.length > 0) {
        for (const colaborador of solicitud.colaboradores) {
          const colaboradorData = {
            ...
            capacitacionVencimiento: colaborador.capacitacionVencimiento,
            ...
            mensajeCapacitacion: colaborador.mensajeCapacitacion,
